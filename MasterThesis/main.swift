...
let graph = CGPGraph(inputs: 3, outputs: 1, levelsBack: 1, dimension: .init(rows: 2, columns: 3), operationSet: DefaultOperationSet())
let graph2 = CGPGraph(inputs: 3, outputs: 1, levelsBack: 1, dimension: .init(rows: 2, columns: 3), operationSet: DefaultOperationSet())
